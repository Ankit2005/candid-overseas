...
const SkillMigrant: React.FC = () => {
  return (
    ...
    <div className="md:w-1/2  md:pr-8 mb-4 md:mb-0  relative group">
                <img src="/assets/skill_migrant.svg" alt="Your Image" className="w-full  rounded-lg  transition duration-300 ease-in-out transform group-hover:scale-105"/>
                
            </div>
            <div className="md:w-1/2 ">
                <h1 className="text-3xl font-bold mb-4 ">Skilled Migrant Category</h1>
        ...
        <div className="container mx-a  uto p-4 flex flex-col-reverse md:flex-row items-center justify-center ">
            ...
            <div className="md:w-1/2      md:pr-8 mb-4 md:mb-0 relative group">
                <img src="/assets/skill_migrent_two.svg" alt="Your Image" className="w-full  rounded-lg  transition duration-300 ease-in-out transform group-hover:scale-105"/>
