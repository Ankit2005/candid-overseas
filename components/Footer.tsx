...
{
  /* <footer className="text-white-100 bg-footer bg-bottom bg-no-repeat h-[620px] flex-between body-text w-full gap-y-10 border-t border-black-400 bg-darkBlue px-20 py-12 max-md:flex-col">
