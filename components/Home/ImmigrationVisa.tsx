  ...
  return (
    <div>
      <section className="bg-white dark:bg-gray-900 py-4 px-2 mx-auto max-w-screen-xl lg:py-16">
        <div>
          <div className="bg-gray-50 text-center dark:bg-gray-800 text-2xl dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            <a
              href="#"
            ...
            <h1 className="text-gray-900  dark:text-white text-2xl md:text-5xl font-medium mb-2">
              Immigration & Visa are allowed some <br /> Countries
            </h1>
          </div>
