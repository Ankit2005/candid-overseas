      ...
      <div>
        <div className="container mx-auto py-8 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 p-6">
            ...
            data-aos-duration="2000" className="text-3xl font-semibold text-gray-800">
              We provide full range global logistics solution
            </h1>
            <p   data-aos="fade-up"
            data-aos-anchor-placement="bottom-bottom"
            data-aos-duration="2000" className="text-gray-600 mt-4">
...
/>
              ...
              <p    data-aos="fade-up"
            data-aos-anchor-placement="bottom-bottom"
            data-aos-duration className="ml-2 text-[#211F20] font-bold text-xl">
                Delivery on Time
              </p>
            </div>
            <div className="flex items-center mt-6">
