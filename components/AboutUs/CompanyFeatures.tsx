  ...
  return (
    <div className="bg-lightRed text-gray-800 py-12">
      <div className="container mx-auto text-center">
        <h1 className="heading1 text-3xl font-semibold">I want company feature</h1>
      ...
      <div className="container mx-auto mt-12 flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-6">
        {features.map((feature, index) => (
          <div
            key={index}
            className="group bg-white hover:bg-red-500 hover:text-gray-600 transition duration-300 ease-in-out transform hover:scale-105 rounded-lg overflow-hidden shadow-md flex flex-col items-center p-4"
          >
            <img src={feature.logoUrl} alt={feature.title} className="w-16 h-16 mb-4" />
            <h2 className="text-xl font-semibold text-gray-800 group-hover:text-white">{feature.title}</h2>
